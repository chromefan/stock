...
<script>
    $(function(){
		...
		$('.nav').find('li.three').addClass( 'active')
    })
</script>
<h1>精选股票30只</h1>
<p>默认按照3年投资回报率排序</p>
<table class="table table-bordered table-hover definewidth m10" >
    ...
    <tr>
     ...
     <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($k % 2 );++$k;?><tr>
			...
			<td><?php echo $d['pgr']*100; ?>%</td>
			<td><?php echo $d['g']*100; ?>%</td>
			<td <?php if(($d["chg"]) > "0"): ?>class="red"<?php endif; ?> <?php if(($d["chg"]) < "0"): ?>class="green"<?php endif; ?> ><?php echo $d['chg']*100; ?>%</td>
			<td <?php if(($d["roi_mid"]) > "0.3"): ?>class="red"<?php endif; ?> <?php if(($d["roi_mid"]) < "0.05"): ?>class="green"<?php endif; ?> ><?php echo $d['roi_mid']*100; ?>%</td>
			<td <?php if(($d["roi"]) > "0.3"): ?>class="red"<?php endif; ?> <?php if(($d["roi"]) < "0.05"): ?>class="green"<?php endif; ?> ><?php echo $d['roi']*100; ?>%</td>
