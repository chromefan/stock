...
return  array(
    ...
    /* Cookie设置 */
    'COOKIE_EXPIRE'         => 86400*30,    // Coodie有效期
    'COOKIE_DOMAIN'         => '',      // Cookie有效域名
    'COOKIE_PATH'           => '/',     // Cookie路径
    'COOKIE_PREFIX'         => 'cngen_',      // Cookie前缀 避免冲突
    ...
    'DEFAULT_TIMEZONE'      => 'America/New_York',	// 默认时区
    ...
    'TMPL_PARSE_STRING' => array(
    	...
    	'__CSS__' => '/public/css',
    	'__UPLOAD_PIC__' => '/public/data/pic/',
    	'__UPLOAD_VIDEO__' => '/public/data/video/',
    	'__UPLOAD_AUDIO__' => '/public/data/audio/'
    	),

    /* URL设置 */
	'URL_CASE_INSENSITIVE'  => true,   // 默认false 表示URL区分大小写 true 则表示不区分大小写
